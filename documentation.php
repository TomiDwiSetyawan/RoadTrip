...
<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero overlay page-inside" style="background-image: url(img/bckg-doc.jpg)">
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center">
            <h1 class="heading" data-aos="fade-up">Documentation</h1>
      ...
      <div class="container">
          <div class="container">
              <div class="row justify-content-center text-center mb-5">
                <div class="col-md-8">
                  <h2 class="heading" data-aos="fade-up"><font size="7" face="Showcard Gothic">Documentation of The Trip</font></h2>
                  <br>
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
                    <div class="media media-custom d-block mb-4">
                      ...
                      <div class="media-body"> 
                        ...
                        <h2 class="mt-0 mb-3" style="text-align:center"><a href="#"><?= $row['ket'] ?></a></h2>
                        <p data-aos="fade-up" data-aos-delay="100" style="text-align:center"> </p>
                      </div>
                    </div>
                  </div>
                <?php 
