        ...
        <div class="col-8">
          ...
          <div>
            <?php 
              ...
              @$desti = $_GET['des'];
            ?>
            <a href="destinasi.php"><i class="fas fa-sync-alt" style=" position:fixed; right:5%; bottom:5%; color: black" data-aos="fade"></i></a>
          </div>
          <!-- END menu-toggle -->
  ...
  <section class="section bg-light post">
    <div class="container">
      <div class="container">
        ...
        <!-- terhapus -->
        <form class="search-box" action="trip.php?" method="get" autocomplete="off">
          <input type="text" name="search" class="search-txt" id="search" placeholder="Type to search"/>
        ...
        <div class="row">
          ...
          $query = "";
            ...
            $q = $_GET['search'];
            $query = "SELECT * FROM list_trip Where nama_trip LIKE '%$q%'  ORDER BY id_trip ASC";
            $result = mysqli_query($con, $query);
					} else {
            $query = "SELECT * FROM list_trip WHERE Lokasi = '$desti'";
            $result = mysqli_query($con, $query);
              ...
              <div class="media media-custom d-block mb-4">
                ...
                <div class="media-body">
                  ...
                  <p class="mt-0 mb-3" style="text-align:center">
                    <b>Rp. </b> <font face="Blenda Script"><?= $row['harga'] ?></font> <b>/1 day</b>
                  </p>
